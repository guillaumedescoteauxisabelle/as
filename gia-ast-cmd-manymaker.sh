...
# Make a bunch of commands you can call with all the active agents
...
startapp "GIA-AST Farm Inference Script maker - Script" \
	 "Guillaume Descoteaux-Isabelle" \
	  2021 \
	  "
Usage $0 <file.jpg>
        foreach available port in the farm host  \
	create a bunch of CLI you can run right away with the content you specified	" \
	$LASTREQUIREDARG
